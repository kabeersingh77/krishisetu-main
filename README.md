# KrishiSetu — AI-Powered Direct Agricultural Marketplace
> *"From Farm to Market. Fairer Prices. Smarter Supply Chains."*
...
### 2. KrishiSetu AI Price Engine (Deterministic Multi-Factor Model)
...
- **Supply-Demand Gap Analysis:** Predicts regional deficits and price direction (e.g., *"Tomato supply gap of 1,520 kg in Central MP — recommend increasing listing volume"*).
...
|---|---|---|
| **Farmer** | `farmer@krishisetu.demo` | Rajesh Patel (Indore) |
| **Consumer** | `consumer@krishisetu.demo` | Priya Verma (Bhopal) |
| **Bulk Buyer** | `buyer@krishisetu.demo` | Hotel Spice Garden |
| **FPO Collective** | `fpo@krishisetu.demo` | Narmada Valley FPO |
| **Logistics Partner** | `logistics@krishisetu.demo` | Suresh Transport |
| **Administrator** | `admin@krishisetu.demo` | Platform Administrator |

*Quick login buttons are available on the `/login` page for 1-click credential autofill.*
...
JWT_SECRET="krishisetu-dev-secret-key-2024"
PORT=3000
```
...
- `GET /api/analytics/impact` — Traditional vs KrishiSetu comparative metrics.
