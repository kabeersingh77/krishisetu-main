...
export default function FarmerDashboard() {
  ...
  const metrics = [
    ...
    },
    {
      ...
      value: `₹${data?.avgRealization || 0}/kg`,
      icon: Sparkles,
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Real-time marketplace realization, demand alerts, and order
            processing.
          </p>
        </div>
        ...
        <Card className="border-amber-200 dark:border-amber-900 bg-amber-50/40 dark:bg-amber-950/20">
          ...
          <CardContent className="space-y-2">
            {alerts.map((a, i) => (
              <div
                key={i}
                className="flex flex-col sm:flex-row sm:items-center justify-between p-3 rounded-lg bg-background border gap-2 text-sm"
              >
                <div>
        ...
        <Card className="lg:col-span-2 border shadow-sm">
          <CardHeader>
            <CardTitle className="text-lg">
              Revenue History (Past 30 Days)
            </CardTitle>
            <CardDescription>
              Daily direct buyer earnings through Agriflow
            </CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  >
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground mt-0.5">
                        {o.items
                          .map((i: any) => `${i.quantity}kg ${i.crop}`)
                          .join(", ")}
                      </div>
                    </div>
